...
public class RabbitMQProductNameUpdateConsumer : IDisposable, IRabbitMQProductNameUpdateConsumer
{
    ...
    public void Consume()
    {
        ...
        var headers = new Dictionary<string, object>()
      {
        ...
        _channel.QueueDeclare(queue: queueName, durable: true, exclusive: false, autoDelete: false, arguments: null); //x-message-ttl (time to leave)| x-max-length | x-expired Características del queue
